<template>
  <div>
    <button
      class="mr-2 text-purple-400 hover:text-purple-700"
      @click="openModal"
    >
      Add Stock
    </button>
            ...
            >
              ...
              >
                ...
                <div class="flex flex-inline mt-2">
                  ...
                  <p
                    class="text-sm font-medium text-red-500 ml-3"
                    v-if="current_stock === 0"
                  >
                    Out of Stock
                  </p>
                  <p class="text-sm font-medium text-red-500 ml-3" v-else>
                    {{ current_stock }}
                  </p>
                </div>
