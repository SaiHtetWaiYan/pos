      ...
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          ...
          <p class="mt-2 text-sm text-gray-700">
            ...
            product code , variant , price and stock.
          </p>
        </div>
        <Create
          @passData="getData"
            ...
            >
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="bg-white">
                  <tr
                    v-for="(product, productIdx) in products.data"
                    :key="product.id"
                    :class="productIdx % 2 === 0 ? undefined : 'bg-gray-50'"
                  >
                    <td
                    ...
                    <td
                      class="whitespace-nowrap px-3 py-4 text-sm text-red-500"
