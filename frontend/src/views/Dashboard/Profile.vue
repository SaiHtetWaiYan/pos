<template>
  <div>
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
              <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div v-if="newPasswordError">
                  <ul
                    class="list-disc mt-4 ml-4"
                    v-for="error in newPasswordError"
                    :key="error"
                  >
                    <li>{{ error }}</li>
                  </ul>
                ...
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="relative">
                      <span
                        class="absolute inset-y-0 right-0 flex items-center pl-2 mr-2"
                        @click="current_passwordVisibility"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                      ...
                      <input
                        :type="current_passwordFieldType"
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="relative">
                      <span
                        class="absolute inset-y-0 right-0 flex items-center pl-2 mr-2"
                        @click="confirm_new_passwordVisibility"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                      ...
                      <input
                        :type="confirm_new_passwordFieldType"
        ...
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-red-600">
              ...
              action cannot be undone, and all your data will be lost. If you
              are certain you want to proceed, please enter your password to
            ...
            <div class="shadow overflow-hidden sm:rounded-md">
              <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                <ul class="list-disc mt-4 ml-4" v-if="deletePasswordError">
                  <li class="text-sm font-medium text-red-700">
                    {{ deletePasswordError }}
                  </li>
                </ul>
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="relative">
                      <span
                        class="absolute inset-y-0 right-0 flex items-center pl-2 mr-2"
                        @click="delete_passwordVisibility"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
    ...
    <aside
      v-if="msg"
      class="fixed bottom-4 right-4 z-50 flex items-center justify-center gap-4 rounded-lg bg-green-400 px-5 py-3 text-white"
    >
...
export default {
  ...
  methods: {
    current_passwordVisibility() {
      this.current_passwordFieldType =
        this.current_passwordFieldType === "password" ? "text" : "password";
    },
    new_passwordVisibility() {
      this.new_passwordFieldType =
        this.new_passwordFieldType === "password" ? "text" : "password";
    },
    confirm_new_passwordVisibility() {
      this.confirm_new_passwordFieldType =
        this.confirm_new_passwordFieldType === "password" ? "text" : "password";
    },
    delete_passwordVisibility() {
      this.delete_passwordFieldType =
        this.delete_passwordFieldType === "password" ? "text" : "password";
    },
    onImageChange(e) {
