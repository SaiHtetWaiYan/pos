<template>
  <div>
    ...
    <TransitionRoot as="template" :show="isOpen">
      ...
      >
        <div
          class="flex min-h-screen text-center sm:block sm:px-6 lg:px-8"
          style="font-size: 0"
        >
          <TransitionChild
            as="template"
                      ...
                      <dl class="-my-4 text-sm">
                        <div class="py-4 flex items-center justify-between">
                          <dt class="text-gray-600">
                            Date : {{ order.created_at.substr(11, 8) }}
                            {{
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        class="flex-none w-12 h-12 rounded-lg border border-gray-200 sm:w-20 sm:h-20"
                      />
                      <div
                      ...
                      >
                        ...
                        <div class="flex items-center sm:flex-none sm:block">
                          <p
                            class="text-base leading-5 font-medium text-gray-700 sm:text-sm"
                          >
                            {{ item.quantity }}
                          </p>
                        </div>
