              ...
              >
                ...
                >
                  ...
                  <div class="absolute top-0 right-0 mt-6 mr-6">
                    <button
                      type="button"
                      class="-m-2 p-2 inline-flex text-gray-600 hover:text-gray-700"
                      @click="closeModal"
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <p
                              class="max-w-full text-base leading-5 font-medium text-gray-700 text-left sm:text-sm"
                            >
                              {{ product.quantity }}
                            </p>
                          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mt-5 text-center">
            ...
            <p>
              {{ useAuthStore().street_address }} , {{ useAuthStore().city }} ,
              {{ useAuthStore().state }}
            </p>
            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="(product, index) in products" :key="index">
                  ...
                  <td class="text-right">
                    {{ product.quantity * product.price }} Ks
                  </td>
                </tr>
              </tbody>
            </table>
  ...
  methods: {
    async orderConfirm() {
      try {
        ...
        this.invoice_no = `${new Date().getFullYear()}${
          new Date().getMonth() + 1
