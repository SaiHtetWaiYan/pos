  ...
  <div>
    <div class="grid grid-cols-6 gap-6 mt-6">
      ...
      <div class="col-span-6 sm:col-span-2">
        ...
        >
          <option :value="null" />
          <option :value="brand.id" :key="brand.id" v-for="brand in brands">
            {{ brand.name }}
          </option>
        </select>
      </div>
    ...
    <div class="grid grid-cols-6 gap-6 mt-6">
      <div class="col-span-6 sm:col-span-3 bg-white">
        ...
        >
          ...
          <div
            class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 xl:gap-x-8"
          >
            <a
              href="#"
              class="group"
            ...
            >
              ...
              >
                <img
                  ...
                  class="h-48 w-48 object-cover object-center group-hover:opacity-75"
                />
              </div>
              ...
              <p class="text-red-400" v-if="product.current_stock === 0">
                Out of stock
              </p>
              <button
                type="button"
      ...
      <div class="col-span-6 sm:col-span-3 bg-white">
        <div class="max-w-lg mx-auto py-16 px-4 sm:py-12 sm:px-6 lg:px-0">
          <h1
            class="text-2xl font-bold text-center tracking-tight text-gray-700 sm:text-2xl"
          >
            Cart
          </h1>
                ...
                >
                  ...
                  <div class="ml-4 flex-1 flex flex-col sm:ml-6">
                    ...
                    <div class="mt-4 flex-1 flex items-end justify-between">
                      <p
                        class="flex items-center text-sm text-gray-700 space-x-2"
                      ></p>
                      <div class="ml-4">
                        <button
                          type="button"
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <dd>
                      <input
                        ...
                        min="0"
                        v-model="discount"
                        class="ml-4 text-base font-medium text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm border-gray-100 rounded-md text-right"
                      />
