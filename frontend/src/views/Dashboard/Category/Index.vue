      ...
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          ...
          <p class="mt-2 text-sm text-gray-700">
            A list of all the categories in your account created name and show.
          </p>
        </div>
            ...
            >
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="bg-white">
                  <tr
                    v-for="(category, categoryIdx) in categories.data"
                    :key="category.id"
                    :class="categoryIdx % 2 === 0 ? undefined : 'bg-gray-50'"
                  >
                    <td
